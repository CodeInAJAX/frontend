    ...
    videos: [
      {
        ...
        duration: "15 menit",
        description: "Pengenalan dasar tentang framework Laravel dan cara kerjanya.",
      },
      {
        id: 2,
        title: "Routing Dasar",
        ...
        duration: "20 menit",
        description: "Mempelajari cara membuat dan mengelola routing di Laravel.",
      },
      {
        id: 3,
        ...
        duration: "25 menit",
        description: "Implementasi controller dan view untuk membangun aplikasi web dengan Laravel.",
      },
    ],
  },
  {
    ...
    videos: [
      ...
      },
      {
        ...
        duration: "30 menit",
        description: "Memahami konsep goroutine dan channel untuk concurrent programming.",
      },
    ],
  },
  {
...
export const paymentMethods = [
  ...
  { id: "credit_card", name: "Kartu Kredit", description: "Visa, Mastercard, American Express" },
  { id: "bank_transfer", name: "Transfer Bank", description: "BCA, Mandiri, BNI, BRI" },
  { id: "e_wallet", name: "E-Wallet", description: "GoPay, OVO, Dana, LinkAja" },
]
